...
public class L_1129_ShortestPathwithAlternatingColorsTest {
    ...
    public void firstTest() {
        ...
        assertArrayEquals(myClass.shortestAlternatingPaths(3, redEdges, blueEdges), new int[] {0,1,-1});
    }
    ...
    public void thirdTest() {
        ...
        assertArrayEquals(myClass.shortestAlternatingPaths(5, redEdges, blueEdges), new int[] {0,1,2,3,7});
    }
    ...
    public void fifthTest() {
        ...
        int[][] blueEdges = new int[][] {};
        assertArrayEquals(myClass.shortestAlternatingPaths(1, redEdges, blueEdges), new int[] {0});
    }
    ...
    public void sixthTest() {
        ...
        assertArrayEquals(myClass.shortestAlternatingPaths(5, redEdges, blueEdges), new int[] {0,2,-1,1,2});
    }
    ...
    public void seventhTest() {
        ...
        assertArrayEquals(myClass.shortestAlternatingPaths(5, redEdges, blueEdges), new int[] {0,2,-1,-1,1});
    }
    ...
    public void eighthTest() {
        ...
        assertArrayEquals(myClass.shortestAlternatingPaths(5, redEdges, blueEdges), new int[] {0,1,2,1,1});
    }
    ...
    public void ninthTest() {
        ...
        assertArrayEquals(myClass.shortestAlternatingPaths(5, redEdges, blueEdges), new int[] {0,1,2,2,1});
    }
    ...
    public void tenthText() {
        ...
        assertArrayEquals(myClass.shortestAlternatingPaths(9, redEdges, blueEdges), new int[] {0,5,3,1,8,1,5,2,2});
    }
}