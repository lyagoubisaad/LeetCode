...
public class L_399_EvaluateDivisionTest {
    ...
    public void firstTest() {
        ...
        assertArrayEquals(myClass.calcEquation(equations, values, queries), new double[] {6.00000,0.50000,-1.00000,1.00000,-1.00000});
    }
    ...
    public void secondTest() {
        ...
        assertArrayEquals(myClass.calcEquation(equations, values, queries), new double[] {3.75000,0.40000,5.00000,0.20000});
    }
    ...
    public void thirdTest() {
        ...
        assertArrayEquals(myClass.calcEquation(equations, values, queries), new double[] {0.50000,2.00000,-1.00000,-1.00000});
    }
    ...
    public void forthTest() {
        ...
        assertArrayEquals(myClass.calcEquation(equations, values, queries), new double[] {360.00000,0.008333333333333333,20.00000,1.00000,-1.00000,-1.00000});
    }
