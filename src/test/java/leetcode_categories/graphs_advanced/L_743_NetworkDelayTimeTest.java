...
public class L_743_NetworkDelayTimeTest {
    ...
    void convert() {
        ...
        convertor.toBracesAndSingleQuotes("[[2,1,1],[2,3,1],[3,4,1]]");
        convertor.toBracesAndSingleQuotes("[[1,2,1]]");
        convertor.toBracesAndSingleQuotes("[[1,2,1]]");
        convertor.toBracesAndSingleQuotes("[[1,2,1],[2,1,3]]");
        convertor.toBracesAndSingleQuotes("[[1,2,1],[2,3,2],[1,3,1]]");
    }
