...
public class L_778_SwimRisingWaterTest {
    ...
    @Test
    void convert() {
        convertor.toBracesAndSingleQuotes("[[0,2],[1,3]]");
        convertor.toBracesAndSingleQuotes("[[0,1,2,3,4],[24,23,22,21,5],[12,13,14,15,16],[11,17,18,19,20],[10,9,8,7,6]]");
        convertor.toBracesAndSingleQuotes("[[3,2],[0,1]]");
    }
