...
public class L_787_CheapestFlightsWithinKStopsTest {
    ...
    @Test
    void convert() {
        convertor.toBracesAndSingleQuotes("[[0,1,100],[1,2,100],[2,0,100],[1,3,600],[2,3,200]]");
        convertor.toBracesAndSingleQuotes("[[0,1,100],[1,2,100],[0,2,500]]");
        convertor.toBracesAndSingleQuotes("[[0,1,100],[1,2,100],[0,2,500]]");
        convertor.toBracesAndSingleQuotes("[[0,3,3],[3,4,3],[4,1,3],[0,5,1],[5,1,100],[0,6,2],[6,1,100],[0,7,1],[7,8,1],[8,9,1],[9,1,1],[1,10,1],[10,2,1],[1,2,100]]");
    }
